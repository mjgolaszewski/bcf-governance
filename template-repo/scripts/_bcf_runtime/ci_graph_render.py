...
def _command_step(
    ...
    environment = {"BCF_PYTHON": "python", **command["environment"]}
    ...
    return [
        {
            ...
            "with": {
                ...
                "path": compiled.graph["artifacts"][artifact]["path"],
        ...
        return [
            {
                ...
                "shell": "bash",
                "env": {"BCF_PYTHON": "python", "BCF_GATES": gates},
                "run": (
                    "set -euo pipefail\n"
    ...
    if executor["kind"] == "authority":
        ...
        arguments = {
            ...
            "finalize": (
                ...
                '--output ".artifacts/bcf/exact-main-certification"'
            ),
            "publish": (
                'exact-main publish --repository "$GITHUB_REPOSITORY" '
                '--bundle ".artifacts/bcf/exact-main-certification" '
